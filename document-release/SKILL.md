...
- Is the required .NET SDK version documented? Does it match the csproj TargetFramework?
- Are device configuration steps documented (what config files are needed before first run)?
